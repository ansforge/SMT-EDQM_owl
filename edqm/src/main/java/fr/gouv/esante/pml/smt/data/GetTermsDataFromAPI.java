...
public class GetTermsDataFromAPI {

	String data = null;

	public TermsList getTerms(String clazz) throws Exception {

		String uri = "https://standardterms.edqm.eu/standardterms/api/v1/basic_data_by_class/" + clazz + "/1/1";

		data = getURI(uri, clazz);
		ObjectMapper om = new ObjectMapper();
		TermsList root = om.readValue(data, TermsList.class);
		return root;
	}
	...
	private String getURI(String uri, String clazz) throws Exception {
		...
		String ur = "/standardterms/api/v1/basic_data_by_class/" + clazz + "/1/1";
