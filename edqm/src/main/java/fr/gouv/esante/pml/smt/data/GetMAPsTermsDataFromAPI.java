...
public class GetMAPsTermsDataFromAPI {

	String data = null;

	public RootMAP getTerms() throws Exception {

		String uri = "https://standardterms.edqm.eu/standardterms/api/v1/mapping/1";

		data = getURI(uri);
		ObjectMapper om = new ObjectMapper();
		RootMAP root = om.readValue(data, RootMAP.class);
		return root;
	}
...
//		System.setProperty("https.proxyPort", "3128");
		...
		String ur = "/standardterms/api/v1/mapping/1";
