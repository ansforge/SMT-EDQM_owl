...
public class GetClassesDataFromAPI {

	String data = null;

	public ClassList getClassesList() throws Exception {

		String uri = "https://standardterms.edqm.eu/standardterms/api/v1/classes";

		data = getURI(uri);
		System.out.println(data);
		ObjectMapper om = new ObjectMapper();
		ClassList root = om.readValue(data, ClassList.class);
		return root;
	}
...
//		System.setProperty("https.proxyPort", "3128");
		...
		String ur = "/standardterms/api/v1/classes";
